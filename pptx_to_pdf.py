...
If you do not want to use PowerPoint itself to perform the conversion,
and is willing to use other converters, you can check:
https://www.thewindowsclub.com/batch-convert-powerpoint-ppt-or-pptx-to-pdf
